...
Kitronik_Game_Controller.onButtonPress(Kitronik_Game_Controller.ControllerButtonPins.FireX, Kitronik_Game_Controller.ControllerButtonEvents.Down, function () {
    basic.showString("X")
})
Kitronik_Game_Controller.onButtonPress(Kitronik_Game_Controller.ControllerButtonPins.FireY, Kitronik_Game_Controller.ControllerButtonEvents.Down, function () {
    basic.showString("Y")
})
Kitronik_Game_Controller.onButtonPress(Kitronik_Game_Controller.ControllerButtonPins.FireL, Kitronik_Game_Controller.ControllerButtonEvents.Down, function () {
    basic.showString("L")
})
Kitronik_Game_Controller.onButtonPress(Kitronik_Game_Controller.ControllerButtonPins.FireR, Kitronik_Game_Controller.ControllerButtonEvents.Down, function () {
    basic.showString("R")
})

Kitronik_Game_Controller.setBuzzerPin()
basic.forever(function () {
   // if (Kitronik_Game_Controller.buttonIsPressed(Kitronik_Game_Controller.ControllerButtonPins.FireL)) {
   //    music.beginMelody(music.builtInMelody(Melodies.Funk), MelodyOptions.Once)
   // } else if (Kitronik_Game_Controller.buttonIsPressed(Kitronik_Game_Controller.ControllerButtonPins.FireR)) {
